...
class GUI:
    def __init__(self, cell, victory_cell):
        ...
        for i in range(8):
            ...
            x2 = x2 + 64
        self.Screen.blit(textsurface, (600, 100))
        self.Screen.blit(textsurface, (600, 500))
        self.board = cell
    ...
    def scoreUpdate(self, bScore, wScore):
        pygame.draw.rect(self.Screen, GREY, pygame.Rect(700, 100, 100, 100))
        pygame.draw.rect(self.Screen, GREY, pygame.Rect(700, 500, 100, 100))
        blackScore = str(bScore)
        whiteScore = str(wScore)
        textsurface = myfont.render(blackScore, False, ROSE)
        self.Screen.blit(textsurface, (700, 100))
        textsurface = myfont.render(whiteScore, False, ROSE)
        self.Screen.blit(textsurface, (700, 500))
